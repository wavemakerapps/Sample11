 ...
 * 2017-12-13T08:54:16.366Z
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "Calculator", 
                  wsdlLocation = "test1.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = Calculator.class.getResource("test1.wsdl");
        if (url == null) {
            url = Calculator.class.getClassLoader().getResource("test1.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "test1.wsdl");
        }       
        WSDL_LOCATION = url;
    }
