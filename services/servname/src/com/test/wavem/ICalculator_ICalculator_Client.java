...
public final class ICalculator_ICalculator_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        com.test.wavem.Multiply _multiply_parameters = null;
        com.test.wavem.MultiplyResponse _multiply__return = port.multiply(_multiply_parameters);
        ...
        com.test.wavem.Subtract _subtract_parameters = null;
        com.test.wavem.SubtractResponse _subtract__return = port.subtract(_subtract_parameters);
        ...
        com.test.wavem.Add _add_parameters = null;
        com.test.wavem.AddResponse _add__return = port.add(_add_parameters);
        ...
        com.test.wavem.Divide _divide_parameters = null;
        com.test.wavem.DivideResponse _divide__return = port.divide(_divide_parameters);
