 ...
 * 2017-12-13T09:27:09.441Z
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "Calculator", 
                  wsdlLocation = "servname.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = Calculator.class.getResource("servname.wsdl");
        if (url == null) {
            url = Calculator.class.getClassLoader().getResource("servname.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "servname.wsdl");
        }       
        WSDL_LOCATION = url;
    }
