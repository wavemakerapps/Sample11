 ...
 * 2017-12-13T09:07:13.166Z
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "Calculator", 
                  wsdlLocation = "test3.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = Calculator.class.getResource("test3.wsdl");
        if (url == null) {
            url = Calculator.class.getClassLoader().getResource("test3.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "test3.wsdl");
        }       
        WSDL_LOCATION = url;
    }
