...
@XmlRootElement(name = "SummaryPNRExt")
public class SummaryPNRExt {

    @XmlElementRef(name = "SummaryPnrRequest", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<SummaryPNR> summaryPnrRequest;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SummaryPNR }{@code >}
     *     
     */
    public JAXBElement<SummaryPNR> getSummaryPnrRequest() {
     ...
     *     
     */
    public void setSummaryPnrRequest(JAXBElement<SummaryPNR> value) {
