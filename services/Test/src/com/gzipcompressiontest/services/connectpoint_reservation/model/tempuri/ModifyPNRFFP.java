...
@XmlRootElement(name = "ModifyPNRFFP")
public class ModifyPNRFFP {

    @XmlElementRef(name = "ModifyPnrRequest", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ModifyPNR> modifyPnrRequest;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ModifyPNR }{@code >}
     *     
     */
    public JAXBElement<ModifyPNR> getModifyPnrRequest() {
     ...
     *     
     */
    public void setModifyPnrRequest(JAXBElement<ModifyPNR> value) {
