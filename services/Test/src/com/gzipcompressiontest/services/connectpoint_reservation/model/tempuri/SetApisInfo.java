 ...
 *         &lt;element name="ApisInfoXML" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "SetApisInfo")
public class SetApisInfo {
    ...
    @XmlElementRef(name = "ApisInfoXML", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> apisInfoXML;
    @XmlElementRef(name = "CheckinAgent", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the apisInfoXML property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getApisInfoXML() {
        return apisInfoXML;
    }

    /**
     * Sets the value of the apisInfoXML property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setApisInfoXML(JAXBElement<String> value) {
        this.apisInfoXML = value;
    }
