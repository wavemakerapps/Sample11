 ...
 * 2017-12-13T09:12:58.825Z
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "Calculator", 
                  wsdlLocation = "testnew.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = Calculator.class.getResource("testnew.wsdl");
        if (url == null) {
            url = Calculator.class.getClassLoader().getResource("testnew.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "testnew.wsdl");
        }       
        WSDL_LOCATION = url;
    }
