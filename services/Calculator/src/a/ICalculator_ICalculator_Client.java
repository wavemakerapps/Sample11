...
public final class ICalculator_ICalculator_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        a.Multiply _multiply_parameters = null;
        a.MultiplyResponse _multiply__return = port.multiply(_multiply_parameters);
        ...
        a.Subtract _subtract_parameters = null;
        a.SubtractResponse _subtract__return = port.subtract(_subtract_parameters);
        ...
        a.Add _add_parameters = null;
        a.AddResponse _add__return = port.add(_add_parameters);
        ...
        a.Divide _divide_parameters = null;
        a.DivideResponse _divide__return = port.divide(_divide_parameters);
